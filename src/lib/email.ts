...
<div style="font-family: sans-serif; color: #111; max-width: 600px; margin: 0 auto; padding: 2rem; border: 1px solid #eaeaea; border-radius: 4px;">
  <h1 style="font-family: 'Times New Roman', Times, serif; font-size: 1.5rem; text-transform: uppercase; font-weight: bold; margin-bottom: 0.5rem; letter-spacing: 0.1em; color: #FFFFFF;">THE POSTMORTEM<span style="color: #D50000;">S.</span></h1>
