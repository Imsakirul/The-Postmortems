...
export const metadata = {
  title: "Funding Disclosure | The Postmortem",
  ...
  return (
    <main className={styles.container}>
      ...
      <section className={styles.content}>
        ...
        <p>At The Postmortem, we treat our financial structure as public information. Our commitment to funding transparency is designed to preemptively dismantle questions regarding the motivations behind our investigations.</p>
        ...
        <p>The Postmortem enforces a strict, zero-tolerance prohibition on funding from political parties, elected officials, active political candidates, or designated Political Action Committees (PACs). We do not accept funding that is routed through proxy organizations designed to obscure political origins.</p>

        <h2 id="conflicts-of-interest">13. Conflicts of Interest</h2>
        <p>Every employee and contractor at The Postmortem is required to disclose any financial relationships, investments, or affiliations that could present a conflict of interest with their reporting. We do not permit our staff to investigate entities in which they hold a direct financial stake.</p>
